...
NV_seen_output_dir="/out/affectron/${model_name}/wavs/seen_NV"
VVNV_tail_seen_output_dir="/out/affectron/${model_name}/wavs/seen_VVNV_tail"
filler_seen_output_dir="/out/affectron/${model_name}/wavs/seen_filler"
...
NV_unseen_output_dir="/out/affectron/${model_name}/wavs/unseen_NV"
VVNV_tail_unseen_output_dir="/out/affectron/${model_name}/wavs/unseen_VVNV_tail"
filler_unseen_output_dir="/out/affectron/${model_name}/wavs/unseen_filler"
...
for step in 50000; do
  python inference_tts.py \
    ...
    --manifest_fn "./manifest/final_test_VV_seen.txt"
done
...
for step in 50000; do
  python inference_tts.py \
    ...
    --manifest_fn "./manifest/final_test_VVNV_seen.txt"
done
...
for step in 50000; do
  python inference_tts.py \
    ...
    --manifest_fn "./manifest/final_test_VV_unseen.txt"
done
...
for step in 50000; do
  python inference_tts.py \
    ...
    --manifest_fn "./manifest/final_test_VVNV_unseen.txt"
done