...
def MyParser():
    ...
    parser.add_argument("--emotion_driven_nv_matching", type=int, default=0)
    parser.add_argument("--emotion_aware_routing", type=int, default=0)
    parser.add_argument("--min_based_position_select", type=int, default=0)
    parser.add_argument("--emotion_aware_structural_masking", type=int, default=0)
